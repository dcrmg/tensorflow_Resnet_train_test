...
def main():  # pylint: disable=unused-argument
    ...
    parser.add_argument('--batch_size', default= 16, type= int, action= 'store', help= 'The training batch size')
    ...
    parser.add_argument('--num_epochs', default= 1055, type= int, action= 'store', help= 'The number of epochs')
